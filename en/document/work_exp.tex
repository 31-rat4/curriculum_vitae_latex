...
\begin{cventries}
    ...
    %---------------------------------------------------------
    \cventry
   {CTO / Founder } % Job title
   {Ignota Security} % Organization
   {SP, Brasil} % Location
   {Mar. 2023 - NOW} % Date(s)
   {
   	\begin{cvitems} % Description(s) of tasks/responsibilities
   		\item {Penetration Testing for Cybersecurity Assessment.}
   		\item {Information Gathering, Intelligence, and Counterintelligence with MITRE mapping.}
   		\item {Training on Cryptocurrencies and Best Practices. Scripts in Solidity for Cybersecurity.}   		
   	\end{cvitems}
   }   	
   	\cventry
	...
	{Mai. 2018 - Dez. 2018} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			...
			\item {Separation of ServiceNow instances for a multitenancy environment.}
			\item {Creation of a static code analysis tool for best practices and instance health.}
