...
\begin{cventries}
    ...
    %---------------------------------------------------------
    	\cventry
    {CTO / Fundador} % Job title
    {Ignota Security} % Organization
    {SP, Brasil} % Location
    {mar. 2023 - Agora} % Date(s)
    {
    	\begin{cvitems} % Description(s) of tasks/responsibilities
    		\item {Testes de Penetração para Avaliação de Cibersegurança.}
    		\item {Coleta de informações, Inteligência e Contrainteligência com mapeamento MITRE.}
    		\item {Treinamentos sobre Criptomoedas e melhores práticas. Scripts em Solidity para cibersegurança.}					
    	\end{cvitems}
    }   
	...
	{SP, Brasil} % Location
	{Mai. 2018 - Dez. 2018} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			\item {Desenvolvimento/Customização com a plataforma ServiceNOW(Gerenciador de processos em Cloud baseado em ITIL).}
			\item {Criação de ferramenta de análise estática de código para boas práticas.}
			\item {Separação de instancias serviceNOW para ambiente multi-empresarial.}
